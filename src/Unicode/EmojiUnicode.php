...
interface EmojiUnicode
{
    ...
    const CHARACTER_FLAG_FOR_ASCENSION_ISLAND = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ANDORRA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_UNITED_ARAB_EMIRATES = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_AFGHANISTAN = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ANTIGUA_AND_BARBUDA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ANGUILLA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ALBANIA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ARMENIA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ANGOLA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ANTARCTICA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ARGENTINA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_AMERICAN_SAMOA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_AUSTRIA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_AUSTRALIA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_ARUBA = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_LAND_ISLANDS = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_AZERBAIJAN = "\u{1F1E6}";
    const CHARACTER_FLAG_FOR_BOSNIA_AND_HERZEGOVINA = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BARBADOS = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BANGLADESH = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BELGIUM = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BURKINA_FASO = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BULGARIA = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BAHRAIN = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BURUNDI = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BENIN = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_ST_BARTHELEMY = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BERMUDA = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BRUNEI = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BOLIVIA = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_CARIBBEAN_NETHERLANDS = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BRAZIL = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BAHAMAS = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BHUTAN = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BOUVET_ISLAND = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BOTSWANA = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BELARUS = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_BELIZE = "\u{1F1E7}";
    const CHARACTER_FLAG_FOR_CANADA = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_COCOS_ISLANDS = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CONGO_KINSHASA = "\u{1F1E8}";
    ...
    const CHARACTER_FLAG_FOR_CHINA = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_COLOMBIA = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CLIPPERTON_ISLAND = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_COSTA_RICA = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CUBA = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CAPE_VERDE = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CURACAO = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CHRISTMAS_ISLAND = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CYPRUS = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_CZECH_REPUBLIC = "\u{1F1E8}";
    const CHARACTER_FLAG_FOR_GERMANY = "\u{1F1E9}";
    const CHARACTER_FLAG_FOR_DIEGO_GARCIA = "\u{1F1E9}";
    const CHARACTER_FLAG_FOR_DJIBOUTI = "\u{1F1E9}";
    const CHARACTER_FLAG_FOR_DENMARK = "\u{1F1E9}";
    const CHARACTER_FLAG_FOR_DOMINICA = "\u{1F1E9}";
    const CHARACTER_FLAG_FOR_DOMINICAN_REPUBLIC = "\u{1F1E9}";
    const CHARACTER_FLAG_FOR_ALGERIA = "\u{1F1E9}";
    const CHARACTER_FLAG_FOR_CEUTA_AND_MELILLA = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_ECUADOR = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_ESTONIA = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_EGYPT = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_WESTERN_SAHARA = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_ERITREA = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_SPAIN = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_ETHIOPIA = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_EUROPEAN_UNION = "\u{1F1EA}";
    const CHARACTER_FLAG_FOR_FINLAND = "\u{1F1EB}";
    const CHARACTER_FLAG_FOR_FIJI = "\u{1F1EB}";
    const CHARACTER_FLAG_FOR_FALKLAND_ISLANDS = "\u{1F1EB}";
    const CHARACTER_FLAG_FOR_MICRONESIA = "\u{1F1EB}";
    const CHARACTER_FLAG_FOR_FAROE_ISLANDS = "\u{1F1EB}";
    const CHARACTER_FLAG_FOR_FRANCE = "\u{1F1EB}";
    const CHARACTER_FLAG_FOR_GABON = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_UNITED_KINGDOM = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GRENADA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GEORGIA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_FRENCH_GUIANA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GUERNSEY = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GHANA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GIBRALTAR = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GREENLAND = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GAMBIA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GUINEA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GUADELOUPE = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_EQUATORIAL_GUINEA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GREECE = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_SOUTH_GEORGIA_AND_SOUTH_SANDWICH_ISLANDS = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GUATEMALA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GUAM = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GUINEA_BISSAU = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_GUYANA = "\u{1F1EC}";
    const CHARACTER_FLAG_FOR_HONG_KONG = "\u{1F1ED}";
    const CHARACTER_FLAG_FOR_HEARD_AND_MCDONALD_ISLANDS = "\u{1F1ED}";
    const CHARACTER_FLAG_FOR_HONDURAS = "\u{1F1ED}";
    const CHARACTER_FLAG_FOR_CROATIA = "\u{1F1ED}";
    const CHARACTER_FLAG_FOR_HAITI = "\u{1F1ED}";
    const CHARACTER_FLAG_FOR_HUNGARY = "\u{1F1ED}";
    const CHARACTER_FLAG_FOR_CANARY_ISLANDS = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_INDONESIA = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_IRELAND = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_ISRAEL = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_ISLE_OF_MAN = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_INDIA = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_BRITISH_INDIAN_OCEAN_TERRITORY = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_IRAQ = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_IRAN = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_ICELAND = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_ITALY = "\u{1F1EE}";
    const CHARACTER_FLAG_FOR_JERSEY = "\u{1F1EF}";
    const CHARACTER_FLAG_FOR_JAMAICA = "\u{1F1EF}";
    const CHARACTER_FLAG_FOR_JORDAN = "\u{1F1EF}";
    const CHARACTER_FLAG_FOR_JAPAN = "\u{1F1EF}";
    const CHARACTER_FLAG_FOR_KENYA = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_KYRGYZSTAN = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_CAMBODIA = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_KIRIBATI = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_COMOROS = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_ST_KITTS_AND_NEVIS = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_NORTH_KOREA = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_SOUTH_KOREA = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_KUWAIT = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_CAYMAN_ISLANDS = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_KAZAKHSTAN = "\u{1F1F0}";
    const CHARACTER_FLAG_FOR_LAOS = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LEBANON = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_ST_LUCIA = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LIECHTENSTEIN = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_SRI_LANKA = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LIBERIA = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LESOTHO = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LITHUANIA = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LUXEMBOURG = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LATVIA = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_LIBYA = "\u{1F1F1}";
    const CHARACTER_FLAG_FOR_MOROCCO = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MONACO = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MOLDOVA = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MONTENEGRO = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_ST_MARTIN = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MADAGASCAR = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MARSHALL_ISLANDS = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MACEDONIA = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MALI = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MYANMAR = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MONGOLIA = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MACAU = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_NORTHERN_MARIANA_ISLANDS = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MARTINIQUE = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MAURITANIA = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MONTSERRAT = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MALTA = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MAURITIUS = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MALDIVES = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MALAWI = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MEXICO = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MALAYSIA = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_MOZAMBIQUE = "\u{1F1F2}";
    const CHARACTER_FLAG_FOR_NAMIBIA = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NEW_CALEDONIA = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NIGER = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NORFOLK_ISLAND = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NIGERIA = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NICARAGUA = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NETHERLANDS = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NORWAY = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NEPAL = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NAURU = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NIUE = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_NEW_ZEALAND = "\u{1F1F3}";
    const CHARACTER_FLAG_FOR_OMAN = "\u{1F1F4}";
    const CHARACTER_FLAG_FOR_PANAMA = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PERU = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_FRENCH_POLYNESIA = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PAPUA_NEW_GUINEA = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PHILIPPINES = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PAKISTAN = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_POLAND = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_ST_PIERRE_AND_MIQUELON = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PITCAIRN_ISLANDS = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PUERTO_RICO = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PALESTINIAN_TERRITORIES = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PORTUGAL = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PALAU = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_PARAGUAY = "\u{1F1F5}";
    const CHARACTER_FLAG_FOR_QATAR = "\u{1F1F6}";
    const CHARACTER_FLAG_FOR_R_UNION = "\u{1F1F7}";
    const CHARACTER_FLAG_FOR_ROMANIA = "\u{1F1F7}";
    const CHARACTER_FLAG_FOR_SERBIA = "\u{1F1F7}";
    const CHARACTER_FLAG_FOR_RUSSIA = "\u{1F1F7}";
    const CHARACTER_FLAG_FOR_RWANDA = "\u{1F1F7}";
    const CHARACTER_FLAG_FOR_SAUDI_ARABIA = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SOLOMON_ISLANDS = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SEYCHELLES = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SUDAN = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SWEDEN = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SINGAPORE = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_ST_HELENA = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SLOVENIA = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SVALBARD_AND_JAN_MAYEN = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SLOVAKIA = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SIERRA_LEONE = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SAN_MARINO = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_SENEGAL = "\u{1F1F8}";
    ...
    const CHARACTER_FLAG_FOR_SWAZILAND = "\u{1F1F8}";
    const CHARACTER_FLAG_FOR_TRISTAN_DA_CUNHA = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TURKS_AND_CAICOS_ISLANDS = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_CHAD = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_FRENCH_SOUTHERN_TERRITORIES = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TOGO = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_THAILAND = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TAJIKISTAN = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TOKELAU = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TIMOR_LESTE = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TURKMENISTAN = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TUNISIA = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TONGA = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TURKEY = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TRINIDAD_AND_TOBAGO = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TUVALU = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TAIWAN = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_TANZANIA = "\u{1F1F9}";
    const CHARACTER_FLAG_FOR_UKRAINE = "\u{1F1FA}";
    const CHARACTER_FLAG_FOR_UGANDA = "\u{1F1FA}";
    const CHARACTER_FLAG_FOR_US_OUTLYING_ISLANDS = "\u{1F1FA}";
    const CHARACTER_FLAG_FOR_UNITED_STATES = "\u{1F1FA}";
    const CHARACTER_FLAG_FOR_URUGUAY = "\u{1F1FA}";
    const CHARACTER_FLAG_FOR_UZBEKISTAN = "\u{1F1FA}";
    const CHARACTER_FLAG_FOR_VATICAN_CITY = "\u{1F1FB}";
    const CHARACTER_FLAG_FOR_ST_VINCENT_AND_GRENADINES = "\u{1F1FB}";
    const CHARACTER_FLAG_FOR_VENEZUELA = "\u{1F1FB}";
    const CHARACTER_FLAG_FOR_BRITISH_VIRGIN_ISLANDS = "\u{1F1FB}";
    const CHARACTER_FLAG_FOR_US_VIRGIN_ISLANDS = "\u{1F1FB}";
    const CHARACTER_FLAG_FOR_VIETNAM = "\u{1F1FB}";
    const CHARACTER_FLAG_FOR_VANUATU = "\u{1F1FB}";
    const CHARACTER_FLAG_FOR_WALLIS_AND_FUTUNA = "\u{1F1FC}";
    const CHARACTER_FLAG_FOR_SAMOA = "\u{1F1FC}";
    const CHARACTER_FLAG_FOR_KOSOVO = "\u{1F1FD}";
    const CHARACTER_FLAG_FOR_YEMEN = "\u{1F1FE}";
    const CHARACTER_FLAG_FOR_MAYOTTE = "\u{1F1FE}";
    const CHARACTER_FLAG_FOR_SOUTH_AFRICA = "\u{1F1FF}";
    const CHARACTER_FLAG_FOR_ZAMBIA = "\u{1F1FF}";
    const CHARACTER_FLAG_FOR_ZIMBABWE = "\u{1F1FF}";
    ...
    const CHARACTER_EMOJI_MODIFIER_FITZPATRICK_TYPE_1_2 = "\u{1F3FB}";
    const CHARACTER_EMOJI_MODIFIER_FITZPATRICK_TYPE_3 = "\u{1F3FC}";
    const CHARACTER_EMOJI_MODIFIER_FITZPATRICK_TYPE_4 = "\u{1F3FD}";
    const CHARACTER_EMOJI_MODIFIER_FITZPATRICK_TYPE_5 = "\u{1F3FE}";
    const CHARACTER_EMOJI_MODIFIER_FITZPATRICK_TYPE_6 = "\u{1F3FF}";
